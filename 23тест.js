const questions = [
    ...
    {
        question: "Какие программы используют для уменьшения объема файлов?",
        optionA: 
...

    {
        ...
        "системный файл",
        optionD: 
        "набор файлов, папок и других данных, сжатых и сохраненных в одном",
        correctOption: "optionC"
    },

    {
        question: "Сжатый файл представляет собой …",
        optionA: 
    ...
    {
        question: "Сжатый (архивированный)  файл отличается от исходного тем, что... ",
        optionA:
    ...
    {
        question: "Укажите программы-архиваторы:",
        optionA: 
        "WinZip, WinRar",
        optionB: 
        "WordArt",
    ...
    {
        question: "Программы WinRar и WinZip предназначены…",
        optionA: 
    ...
    {
        question: "Чтобы архивировать файл или папку, надо …",
        optionA: 
        ...
        optionC:
         "в меню Файл выбрать команды Создать - Текстовый документ - нажать ОК",
        optionD:
    ...
    {
        question: "Какое из названных действий необходимо произвести со сжатым  файлом перед началом работы?",
        optionA:
         "переформатировать",
        optionB: 
    ...
    {
        question: "Что может содержать в себе архивный файл?",
        optionA: 
        "только папки",
        optionB: 
        "только файлы",
